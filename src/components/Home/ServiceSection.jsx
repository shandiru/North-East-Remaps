...
const services = [
  {
    title: "Durham Remap",
    desc: "Professional ECU remapping to optimize engine performance and enhance fuel efficiency.",
    image: "/ecu-remapping.avif",
    path: "/services/ecu-remapping",
  },
  {
    title: "Car Diagnostic",
    desc: "Expert car diagnostics and repairs for all makes and models, ensuring reliable performance and safety.",
    image: "/dpf-cleaning.avif",
    path: "/services/car-diagnostics",
  },
  {
    title: "Car Coverage",
    desc: "Advanced carbon cleaning services to improve engine efficiency, performance, and longevity.",
    image: "/carbon-cleaning.avif",
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-40 "
                    onError={(e) => {
